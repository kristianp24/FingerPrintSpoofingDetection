from lda import LDA
from utils import split_db_2to1, load, plot_simple_hist
import numpy as np
from pca import PCA
...
pca = PCA(DTR, LTR, components=2)

DP_pca, P = pca.train_pca()

lda = LDA(DP_pca, LTR, no_clases=2)

DP_lda, W = lda.train_lda()
